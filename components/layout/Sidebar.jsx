...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/wa-insights',   label: 'Insights WA',      icon: '📈', roles: ['owner', 'manager', 'accounting'], brands: ['khasanah'] },
      { href: '/wa-broadcast',  label: 'Broadcast WABA',   icon: '📣', roles: ['pic', 'owner', 'accounting', 'manager', 'ops', 'cs'], brands: ['khasanah'] },
