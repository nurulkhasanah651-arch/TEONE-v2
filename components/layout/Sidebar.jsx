...
// Round 120: Tambah link 💸 Refunds + 📨 Invoices di sidebar
        ...
        {NAV.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.disabled && (
                <span className="ml-auto text-[9px] uppercase tracking-wider bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded">soon</span>
              )}
            </Link>
          );
        })}
