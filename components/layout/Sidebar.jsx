...
const NAV_ALL = [
  ...
  { href: '/tasks',             label: 'To-Do List',     icon: '✅' },  // Round 40
  { href: '/chat',              label: 'Chat Tim',       icon: '💬' },  // Round 40
];
  ...
  return (
    <aside className="hidden md:flex md:flex-col md:w-60 md:fixed md:inset-y-0 md:left-0 bg-white border-r border-slate-200 z-30">
      <div className="flex items-center gap-3 px-5 h-16 border-b border-slate-200">
        <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-brand-500 to-brand-700 flex items-center justify-center text-white text-lg">✈</div>
        <div>
