...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/operasional/profit-estimate', label: 'Estimate Profit', icon: '📈', roles: ['owner', 'accounting', 'manager', 'ops'] },
      { href: '/operasional/tour-confirmation', label: 'Tour Confirmation', icon: '📄', roles: ['pic', 'owner', 'accounting', 'manager', 'ops', 'cs'] },
      { href: '/operasional/optional-tour', label: 'Optional Tour', icon: '🎈', roles: ['pic', 'owner', 'accounting', 'manager', 'ops'] },
      { href: '/operasional/itinerary', label: 'Itinerary Only', icon: '🧭', roles: ['pic', 'owner', 'accounting', 'manager', 'ops'] },
      { href: '/operasional/roomlist', label: 'Final Roomlist', icon: '🛏', roles: ['pic', 'owner', 'accounting', 'manager', 'ops'] },
      { href: '/operasional/ticketing', label: 'Ticketing', icon: '🎫', roles: ['pic', 'owner', 'accounting', 'manager', 'ops'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/inbox',         label: 'Inbox WhatsApp',   icon: '💬', roles: ['pic', 'owner', 'accounting', 'manager', 'ops', 'cs'], brands: ['khasanah', 'teone'] },
      { href: '/wa-insights',   label: 'Insights WA',      icon: '📈', roles: ['owner', 'manager', 'accounting'], brands: ['khasanah', 'teone'] },
      { href: '/wa-broadcast',  label: 'Broadcast WABA',   icon: '📣', roles: ['pic', 'owner', 'accounting', 'manager', 'ops', 'cs'], brands: ['khasanah', 'teone'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/tl-blast',     label: 'Blast TL',     icon: '📣', roles: ['owner', 'manager', 'ops', 'accounting'] },
      { href: '/mitra-master', label: 'Master Mitra', icon: '🤝', roles: ['pic', 'owner', 'accounting', 'manager', 'ops', 'cs'] },
      { href: '/mitra', label: 'Portal Mitra (Preview)', icon: '👀', roles: ['pic', 'owner', 'accounting', 'manager', 'ops', 'cs'] },
    ],
  },
  {
    key: 'data',
