...
export default function Header({ user, role = null }) {
  ...
  async function handleResetRole() {
    if (!confirm('Reset role? Kamu akan diminta pilih role lagi setelah refresh.')) return;
          ...
          <>
            ...
            <div className="absolute right-0 mt-2 w-64 bg-white border border-slate-200 rounded-lg shadow-lg z-20 py-1.5">
              <div className="px-4 py-2 border-b border-slate-100">
                ...
                <p className={`mt-1 text-[10px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded inline-block ${roleBadge}`}>
                  {roleLabel}
                </p>
              </div>
