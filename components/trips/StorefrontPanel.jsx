...
export default function StorefrontPanel({ trip, isKh = false }) {
  ...
  const EXTRA_LABELS = { tips: 'Tipping & Service', city_tax: 'City Tax', domestic_baggage: 'Bagasi Domestik', domestic_flight: 'Tiket Domestik', harga_jual_base: 'Base', visa: 'Visa', asuransi: 'Asuransi', perlengkapan: 'Perlengkapan', asuransi_tips_local_guide: 'Asuransi & Tips Local Guide', handling_perlengkapan: 'Handling & Perlengkapan', visa_asuransi: 'Visa & Asuransi' };
