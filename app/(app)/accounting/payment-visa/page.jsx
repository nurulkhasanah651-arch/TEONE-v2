...
import { getVisaApplyList } from '@/lib/actions/visa-payment';
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4">
      <div>
        ...
        <p className="mt-1 text-slate-600">Pembayaran apply visa per peserta. Nama & status visa otomatis dari Master Trip & tab Visa — tinggal isi biaya embassy/TLS, tanggal, & PIC.</p>
      </div>
