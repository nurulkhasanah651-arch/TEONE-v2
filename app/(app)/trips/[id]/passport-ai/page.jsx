...
// Round 138: Standalone page untuk Tambah Peserta via Passport AI di master trip
// Path: app/(app)/trips/[id]/passport-ai/page.jsx
// SAFE: gak touch component lain, kalau page ini crash gak ganggu master trip / dashboard
  ...
  () => import('@/components/cs/PassportUploadAI').catch(() => ({
    default: () => (
      <div className="p-3 bg-amber-50 border border-amber-200 rounded text-xs text-amber-800">
        ⚠ PassportUploadAI component belum ter-upload. Cek <code>components/cs/PassportUploadAI.jsx</code>.
      </div>
    ),
  })),
    ...
    <div className="max-w-4xl mx-auto space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-600 mt-1">
          Upload foto passport → AI otomatis baca data → field auto-keisi. Edit kalau perlu, terus submit.
        </p>
      </div>
      ...
      {success ? (
        <div className="p-8 bg-green-50 border-2 border-green-300 rounded-xl text-center">
          ...
          <p className="text-xl font-bold text-green-800">Peserta berhasil ditambahkan!</p>
