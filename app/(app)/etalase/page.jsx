...
export default async function EtalasePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 md:py-8">
      ...
      <EtalaseManager initialHero={heroImages} initialRegions={regions} initialPrivate={privateImages} initialTerms={termsSaved} termsSeed={termsSeed} initialLogo={r?.logo_url || ''} initialAbout={r?.about_image || ''} />
    </div>
  );
}
