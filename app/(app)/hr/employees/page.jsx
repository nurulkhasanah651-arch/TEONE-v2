...
export default async function EmployeesListPage({ searchParams }) {
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="mt-1 text-slate-600">{list.length} karyawan terdaftar</p>
        </div>
      ...
      {list.length === 0 ? (
        <div className="bg-white rounded-xl border border-slate-200 shadow-card p-12 text-center">
          ...
          <p className="text-lg font-bold text-slate-700">Belum ada karyawan</p>
          <p className="mt-1 text-sm text-slate-500">Klik "+ Tambah Karyawan" untuk mulai.</p>
