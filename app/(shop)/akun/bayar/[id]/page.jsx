...
import { getBooking, ADMIN_FEE } from '@/lib/shop/data';
    ...
    <div className="max-w-xl mx-auto px-4 py-8">
      ...
      {next ? (
        <div className="mt-6 space-y-4">
          ...
          <PayNextButton bookingId={b.id} milestoneType={next.type} label={next.label} total={next.total} adminFee={ADMIN_FEE} />
