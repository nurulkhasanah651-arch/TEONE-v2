...
export async function getMitraDashboard() {
  ...
  if (!mitra) return { error: 'Akun ini belum tertaut sebagai mitra.' };

  // ── Closingan & Fee mitra ini ──
  ...
  // ── Trip open selling + sisa seat + link web + WA template ──
