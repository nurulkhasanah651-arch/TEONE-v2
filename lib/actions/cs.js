...
// Round 134: CS actions — save passport data ke customers + DP bukti (R133)
...
// R133: DP request now stores dp_proof_url
...
// ROUND 134: build customer payload with passport fields, defensive
function buildCustomerPayload(p, fullName, first, last) {
  ...
  // Optional passport fields — only include if filled
...
// ROUND 134: insert customer with passport fields, retry stripped if columns missing
...
export async function createCSUpdate(formData) {
  ...
  for (let idx = 0; idx < participants.length; idx++) {
    ...
    // ROUND 134: customer with passport data
...
// addParticipantsToCS — also pass passport + dp_proof
