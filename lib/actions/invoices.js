...
export async function getExpectedAndPaidForPassenger(supabase, trip_id, passenger_id) {
  ...
  const mainExpected = roomPrice + tips + cityTax + flight + baggage + baseFee;
  ...
  return { expectedTotal, totalPaid, pokokPaid, addonPaid, sisa, discount, mainExpected, optExpected, nextMilestone, roomPrice, tips, cityTax, flight, baggage, baseFee, roomType };
}
