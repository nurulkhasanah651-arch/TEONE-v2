...
export async function getExpectedAndPaidForPassenger(supabase, trip_id, passenger_id) {
  ...
  const visaExpected = _isKh ? 0 : ((_incVisa || paidTypes.has('Visa')) ? _visaPrice : 0);
  const asuransiExpected = _isKh ? 0 : ((_incAsr || paidTypes.has('Asuransi')) ? _asrPrice : 0);
