...
export async function getExpectedAndPaidForPassenger(supabase, trip_id, passenger_id) {
  ...
  return { expectedTotal, totalPaid, pokokPaid, addonPaid, sisa, discount, mainExpected, optExpected, nextMilestone, roomPrice, tips: effTips, cityTax: effCity, flight: effFlight, baggage: effBaggage, baseFee: effBase, roomType };
}
