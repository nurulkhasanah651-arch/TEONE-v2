...
// R195h: PNR actions — FIX number parsing (Indonesia format "100.000")
// Bug sebelumnya: parseInt("100.000") = 100 (cuma ambil sebelum titik)
// Fix: strip titik & koma dulu sebelum parseInt
...
// R195h: parse number Indonesian format ("100.000" → 100000)
function toInt(v) {
  if (v === null || v === undefined || v === '') return 0;
  // Strip titik (thousand separator ID), koma (decimal separator US), spasi
...
// ============================================================
// CREATE PNR — R195h: pakai toInt() biar handle format "100.000"
// ============================================================
export async function createPnr(formData) {
  ...
  const payload = {
    ...
    // R195h: pakai toInt biar "100.000" jadi 100000 (bukan 100)
    pax: toInt(formData.get('pax')),
    price_per_pax: toInt(formData.get('price_per_pax')),
