...
// R195g: PNR actions — REDIRECT after save (fix form stuck)
// Sebelumnya: action return { ok: true } → form gak tau udah selesai → stuck "Menyimpan..."
// Sekarang: action redirect ke /finance/pnr → form auto navigate → loading state berhenti
...
async function syncPnrToHPP(supabase, pnrId, tripId, userEmail) {
  ...
  // R195: DELETE-FIRST — hapus existing matching dulu
  try {
    await withTimeout(
...
// ============================================================
// CREATE PNR — R195g: REDIRECT setelah sukses (gak stuck)
// ============================================================
export async function createPnr(formData) {
  ...
  // R195g: REDIRECT setelah sukses — ini yg bikin form gak stuck
  redirect('/finance/pnr');
}

// ============================================================
// UPDATE PNR — R195g: REDIRECT setelah sukses
// ============================================================
