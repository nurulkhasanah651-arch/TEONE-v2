...
export async function updateTripPublicContent(tripId, formData) {
  ...
  // Rincian harga (price_breakdown) — ikut tersimpan dari panel (mis. saat Pakai Template).
  const bdRaw = (formData.get('price_breakdown_json') || '').toString();
  if (bdRaw) {
    try { const o = JSON.parse(bdRaw); if (o && typeof o === 'object' && !Array.isArray(o)) update.price_breakdown = o; } catch {}
  }
...
export async function applyTemplateToTrip(targetTripId, sourceTripId) {
  ...
  try {
    ...
    const upd = {
      ...
      gallery_images: Array.isArray(t.gallery_images) ? t.gallery_images : null,
      itinerary: Array.isArray(t.itinerary) ? t.itinerary : null,
      highlights: t.highlights || null,
      description: t.description || null,
      included: t.included || null,
      excluded: t.excluded || null,
      syarat_visa: t.syarat_visa || null,
      syarat_ketentuan: t.syarat_ketentuan || null,
      price_breakdown: (t.price_breakdown && typeof t.price_breakdown === 'object') ? t.price_breakdown : {},
      dp_amount: t.dp_amount || null,
      web_payment_schedule: Array.isArray(t.web_payment_schedule) ? t.web_payment_schedule : null,
    };
