...
export async function createBooking(formData) {
  ...
  const { data: booking, error } = await db.from('bookings').insert({
    ...
    notes: JSON.stringify({ admin_fee: 0, subtotal: subtotalFull, payment_base: base, composition: compStore, pax_list: paxList, include_visa: includeVisa, visa_ready: visaReady, include_asuransi: includeAsuransi }),
