...
// Guard: hanya staf internal (bukan customer/TL/mitra) boleh transfer/undo peserta.
  ...
  try {
    ...
    for (const oldP of passengersToTransfer) {
      ...
      const skipFields = [
        ...
        'delivery_token',
        // FIX: token UNIK lain di trip_passengers — kalau ikut disalin, insert baris baru
        // gagal "duplicate key" (idx_tp_passport_upload_token / idx_tp_visa_form_token).
        // Dikosongkan; token baru dibuat otomatis saat dibutuhkan (kirim WA upload paspor / form visa).
        'passport_upload_token', 'visa_form_token',
