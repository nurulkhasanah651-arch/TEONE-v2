...
// Item HPP/expense siap-pakai (template) — ops tinggal add.
const EXPENSE_TEMPLATES = [
  { category: 'International Flight', component: '' },
  { category: 'Domestic Flight', component: '' },
  { category: 'Landtour', component: '' },
  { category: 'Handling', component: '' },
  { category: 'Visa', component: '' },
  { category: 'Asuransi', component: '' },
  { category: 'Tipping Driver', component: '' },
  { category: 'Tour Leader', component: '' },
  { category: 'Fee Mitra', component: '' },
  { category: 'Cancellation Fee', component: '' },
];
const HOTEL_ROOMS = [
  { room: 'quad', label: 'Hotel Quad' },
  { room: 'triple', label: 'Hotel Triple' },
  { room: 'double', label: 'Hotel Double' },
  { room: 'single', label: 'Hotel Single' },
];
