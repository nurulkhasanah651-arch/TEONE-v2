...
export const BRAND_UI = {
  teone: { label: 'TEONE', sub: 'One System', title: 'TEONE — Traveling Eropa One System', description: 'Sistem operasi travel terpadu untuk Traveling Eropa' },
  khasanah: { label: 'KHASANAH', sub: 'Travel System', title: 'Khasanah Travel — One System', description: 'Sistem operasi travel terpadu untuk Khasanah Travel' },
};
