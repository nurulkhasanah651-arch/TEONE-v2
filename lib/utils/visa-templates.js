...
Silakan upload dokumen-dokumen berikut via link di atas:
- 📸 Scan/foto KTP
- 📸 Scan/foto Kartu Keluarga
- 📸 Scan/foto Akta Kelahiran (untuk anak)
- 📸 Scan/foto Akta Nikah (kalau menikah)
- 📸 Scan/foto halaman paspor data diri
- 📸 Pas foto digital terbaru (latar putih, format JPG, min 600x600 px)
- 📸 Bukti tabungan / rekening koran 3 bulan terakhir
