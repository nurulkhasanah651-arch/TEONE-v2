...
export function buildRoomlistAOA({ trip = {}, rooms = [] }) {
  const COLS = ['No.', 'First Name/ Given Name', 'Surname', 'Title (Mr/Mrs)', 'Room Type', 'No Room', 'No Room', 'Remarks', 'Req Meals', 'Req Seat', 'Passport Number / KTP', 'Place Of Birth', 'Birthdate', 'Age'];
  ...
  const cols = [{ wch: 5 }, { wch: 28 }, { wch: 18 }, { wch: 9 }, { wch: 10 }, { wch: 8 }, { wch: 8 }, { wch: 10 }, { wch: 10 }, { wch: 9 }, { wch: 18 }, { wch: 16 }, { wch: 13 }, { wch: 5 }];
