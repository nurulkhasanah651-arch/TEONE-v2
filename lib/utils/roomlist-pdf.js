...
const COLS = [
  ...
  'No Room', 'No Room', 'Remarks / Catatan', 'Req Meals', 'Req Seat',
  'Passport No / KTP', 'Place Of Birth', 'Birthdate', 'Age',
];
// lebar kolom (mm) - total ~274mm, muat di A4 landscape (usable ~281mm)
// Remarks dilebarkan supaya catatan peserta (halal meals, kursi roda, dll) terbaca.
const W = [8, 34, 26, 10, 16, 11, 11, 32, 15, 13, 28, 24, 20, 8];
