...
export async function downloadRoomlistPDF({ trip = {}, rooms = [] }) {
  ...
  const COLS = [
    ...
    'Tgl Issue', 'Issuing Office', 'Tgl Expired', 'No. HP', 'Room Type', 'Catatan / Request',
  ];
  const W = showKtp
    ? [6, 17, 17, 6, 14, 13, 6, 16, 17, 20, 12, 15, 12, 14, 13, 15]
    : [7, 22, 22, 9, 18, 15, 7, 19, 15, 18, 15, 17, 15, 28];
