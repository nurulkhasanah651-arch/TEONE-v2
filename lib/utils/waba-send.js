...
async function getPicApicoidPhone(supabase, tripId) {
  try {
    ...
    const cols = 'waba_phone_id, full_name, waba_tpl_invoice, waba_tpl_konfirmasi, waba_tpl_paspor, waba_tpl_ongkir, waba_tpl_pengiriman, waba_tpl_perubahan_jadwal, waba_tpl_finalisasi_tiket';
    let emp = null;
