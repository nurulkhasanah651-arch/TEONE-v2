...
export function buildManifestAOA({ trip = {}, rows = [] }) {
  ...
  const COLS = ['No.', 'First Name', 'Last Name', 'Gender', 'Tempat Lahir', 'Tgl Lahir', 'Umur', ...(showKtp ? ['NIK'] : []), 'No. Paspor', 'Tgl Issue', 'Issuing Office', 'Tgl Expired', 'No. HP', 'Keterangan', 'Catatan / Request'];
  ...
  const cols = [{ wch: 5 }, { wch: 18 }, { wch: 18 }, { wch: 7 }, { wch: 16 }, { wch: 13 }, { wch: 6 }, ...(showKtp ? [{ wch: 18 }] : []), { wch: 18 }, { wch: 13 }, { wch: 18 }, { wch: 13 }, { wch: 16 }, { wch: 18 }, { wch: 28 }];
