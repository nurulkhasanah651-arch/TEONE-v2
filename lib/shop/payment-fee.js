...
export const PAY_METHODS = [
  { key: 'va',      short: 'Virtual Account', desc: 'Mandiri, BNI, BRI, Permata, CIMB', rate: 0,       enabled: ['echannel', 'bni_va', 'bri_va', 'permata_va', 'cimb_va', 'other_va'] },
  { key: 'ewallet', short: 'E-Wallet / QRIS',  desc: 'GoPay, ShopeePay, OVO (via QRIS), QRIS', rate: 0,       enabled: ['gopay', 'shopeepay', 'qris'] },
  { key: 'cc',      short: 'Kartu Kredit / Debit', desc: 'Visa, Mastercard, JCB',             rate: CC_RATE, enabled: ['credit_card'] },
];
