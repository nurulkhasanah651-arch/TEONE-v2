...
// Batas maksimum QRIS per transaksi (aturan QRIS nasional). Di atas ini Midtrans
// tidak menampilkan QR sama sekali → jangan tawarkan QRIS untuk nominal segini.
export const QRIS_MAX = 10000000;
export function qrisAllowed(amount) { return (Number(amount) || 0) <= QRIS_MAX; }
