...
export const PAY_METHODS = [
  ...
  { key: 'qris',    short: 'QRIS (Scan QR)',  desc: 'Scan 1 QR pakai e-wallet / m-banking apa pun (GoPay, OVO, DANA, ShopeePay, dll)', rate: 0, enabled: ['other_qris'] },
  { key: 'ewallet', short: 'GoPay / ShopeePay', desc: 'Buka langsung aplikasi GoPay / GoPay Later / ShopeePay', rate: 0, enabled: ['gopay', 'shopeepay'] },
];
