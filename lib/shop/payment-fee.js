...
export const PAY_METHODS = [
  { key: 'va',      short: 'Transfer Bank / Virtual Account', desc: 'BCA, BNI, BRI, Permata, CIMB, Mandiri', rate: 0,    enabled: ['bca_va', 'bni_va', 'bri_va', 'permata_va', 'cimb_va', 'other_va', 'echannel'] },
