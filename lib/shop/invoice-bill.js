...
export async function getInvoiceBilling(supabase, inv) {
  ...
  return { ids, members, expectedTotal, pokokPaid, sisa, totalPaid, addonPaid, discount, billedTotal, visaExpected, asuransiExpected, milestone: inv?.milestone || null, count: ids.length, isFamily: ids.length > 1 };
}
