...
export async function getInvoiceBilling(supabase, inv) {
  ...
  return { ids, members, addonItems, expectedTotal, pokokPaid, sisa, totalPaid, addonPaid, discount, billedTotal, visaExpected, asuransiExpected, visaCount, asuransiCount, visaPokok, asuransiPokok, visaPokokCount, asuransiPokokCount, ppnTotal, ppnLabel, milestone: inv?.milestone || null, count: ids.length, isFamily: ids.length > 1 };
}
