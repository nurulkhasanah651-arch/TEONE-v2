...
export const STOREFRONT = {
  ...
  khasanah: {
    ...
    googlePlaceId: '', // opsional: isi Place ID manual. Kalau kosong → resolve otomatis dari googlePlaceQuery.
    googlePlaceQuery: 'Khasanah Travel Umrah, Jl. Lowanu, Sorosutan, Umbulharjo, Yogyakarta',
    googlePlaceBias: 'circle:20000@-7.8226,110.3899', // Yogyakarta (Umbulharjo)
    googleReviewUrl: 'https://www.google.com/maps/search/?api=1&query=Khasanah+Travel+Umrah+Yogyakarta',
    googleRating: '5,0',
    googleCount: '937',
    testimonials: [
