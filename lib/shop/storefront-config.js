...
export const STOREFRONT = {
  teone: {
    ...
    bank: { nama: 'BANK BCA', norek: '0379777998', an: 'PT KHASANAH GLOBAL TRAVELINDO' },
    stats: [
  ...
  khasanah: {
    ...
    googlePlaceId: '', // opsional: isi Place ID manual. Kalau kosong → resolve otomatis dari googlePlaceQuery + bias.
    googlePlaceQuery: 'Khasanah Travel', // lokasi Khasanah Travel, Lowanu, Umbulharjo, Yogyakarta
    googlePlaceBias: 'point:-7.818249,110.3759778', // titik persis lokasi (dari Google Maps)
    googleReviewUrl: 'https://www.google.com/maps?cid=11407572391928045712', // link Google Maps Khasanah Travel langsung
    googleRating: '5,0',
    googleCount: '937',
    testimonials: [
      { name: 'Muhamad Kowi', text: 'Perjalanan kami dibuka dengan Turki yang langsung terasa hangat sejak hari pertama. Mas Leo selaku tour leader lokal sungguh sosok yang ramah dan komunikatif—beliau sangat mudah diajak ngobrol, selalu tersenyum, dan nggak pernah sungkan membantu jamaah.', stars: 5, when: 'Google Review' },
      { name: 'Ismiyati', text: 'Umroh plus Aqsho Khasanah 24 Juni–6 Juli dengan TL Kang Wildan Rivky dan muthowif Ust Fajar luar biasa bermakna. Mereka memberikan bimbingan baik dalam hal urutan program, ibadah, motivasi, manajemen hati, dan dokumentasi.', stars: 5, when: 'Local Guide · Google Review' },
      { name: 'Jamaah Khasanah', text: 'Pelayanan amanah dan profesional. Bimbingan ibadah jelas, hotel dekat masjid, jadwal rapi, dan jamaah benar-benar diperhatikan. Alhamdulillah, insya Allah ikut lagi.', stars: 5, when: 'Google Review' },
    ],
    youtube: [],
